 ...
 * http://jqueryte.com
 * jQuery TE 1.4.0
 * Copyright (C) 2020, updated by Sávio Andres (https://github.com/SavioAndres), original by Fatih Koca (fatihkoca@me.com), AUTHOR.txt (http://jqueryte.com/about)
			...
			function j(t) {
				...
				if (m.data("linktype") != "2") M("createlink", d.val());
					...
					c.find("img").each(function() {
						...
						if (!e(this).is("[style*=float]")) e(this).css({
							"float": "left",
